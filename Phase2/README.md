# Final phase 2 & 3 of project: Applying IDBP-extensions, Denoisers and CNNs to damaged pictures from different real smartphones

## Full code: Contact through issues for access
There are more python and matlab unreleased utilities and algorithms, as well as trained CNNs and deep denoisers models, described in presentation and notebooks but not published here.
<br/>
<br/>
**Contact @ChiefsBestPal by making an issues on this repo for access to this source code and ML models**

## Partial code and datasets: On drive 
Main code,datasets and more: https://drive.google.com/drive/u/0/folders/1B4dDQso_TP_I8qZJWxpy9UYYNGxIquGY \

Use as starting point for open-source/academic contributions!
